...
get_chelsa <- function(period,model=NULL,rcp=NULL,sv_dir=getwd(),load2r=TRUE,parallel=TRUE){
  chelsa_urls <- NULL
  if(period == "current"){
    url <- "https://os.zhdk.cloud.switch.ch/envicloud/chelsa/chelsa_V1/climatologies/bio/"
    m_ab <- "chelsa_current"
  ...
  if(period %in% c("2041-2060","2061-2080") && rcp %in% c("rcp26","rcp45","rcp85")){
    ...
    chelsa <- base::readRDS(file.path(system.file("extdata",
                                      ...
                                      "chelsa_vars.rds"))
    if(period == "2041-2060")
      url <- "https://os.zhdk.cloud.switch.ch/envicloud/chelsa/chelsa_V1/cmip5/2041-2060/bio/"
    if(period == "2061-2080")
      url <- "https://os.zhdk.cloud.switch.ch/envicloud/chelsa/chelsa_V1/cmip5/2061-2080/bio/"
