...
partial_roc <- sidebarLayout(position = 'left',
                             sidebarPanel(
                               ...
                               wellPanel(
                                 ...
                                 checkboxInput("sub_sample",label = "Use suitability subsample to build the curve (recommended for big rasters)",value = TRUE),
                                 numericInput('sub_sample_size','Number of points to be sampled',
                                              value = 10000,min = 1,max = 10000000,step = 1),
                                 checkboxInput("parallel_roc",label = "Parallel computation",value = FALSE),
