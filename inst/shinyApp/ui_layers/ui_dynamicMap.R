...
DynamicMap <- div(class="outer",
                      ...
                      leafletOutput(outputId = "dyMap_cas",
                      ...
                      absolutePanel(id = "controls",
                                    ...
                                    selectInput("dataset_dynMap",
                                                "Select a dataset",
                                                choices = c("GBIF data"="gbif_dataset",
                                                            "User data"="user_dataset")),
                                    busyIndicator("Computation In progress",
                                                  wait = 0),
                                    selectInput(inputId = "pointsDynamic",
"Select the data point (data ID) you want to
                                                clean from the data base",
choices = NULL,multiple = TRUE),
                                    shiny::actionButton("cleanDynamic",
                                                        label = "Clean data points"),
                                    downloadButton(outputId = "downDatDyn",
                                                   label = "Download data"),


                                    h4("Polygon of M"),
                                    checkboxInput("define_M",
                                                  label = "Use the polygon of M to filter data",
                                                  value = FALSE),
                                    conditionalPanel("input.define_M == 1",
                                                     tags$div(title="Select if you want to trace your polygon of M or uploaded it from directory",
                                                              ...
                                                              shiny::radioButtons(inputId ="poly_from",
                                                                                  "",
                                                                                  choices = c("Trace polygon using dynamic map"=1,
                                                                                              "Polygon from file"=0))
                                                     ),
                                    ...
                                    br(),
                                    conditionalPanel("input.plotTSDynamic==1",
                                                     dygraphOutput(outputId = "RecordsHistDynamic",
