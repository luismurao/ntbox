...
crop_layers <- reactive({
  ...
  if(!is.null(rasterLayers()) && input$layers2CropMask == "nicheLayersCM" && input$CropMask=="gis_crop" && class(gtoolsPolygon())=="SpatialPolygonsDataFrame")
...
crop_layers_proj <- reactive({
  ...
  if(!is.null(rasterLayers()) && input$layers2CropMask == "projLayersCM" && input$CropMask=="gis_crop" && class(gtoolsPolygon())=="SpatialPolygonsDataFrame")
